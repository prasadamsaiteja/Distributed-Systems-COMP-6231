...
import instance1.client.controller.Controller;
import instance1.client.controller.data.Cache;
...
public class Client {	
	...
	public static void main(String[] args) throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		/*Registry registry = LocateRegistry.getRegistry(Cache.serverPorts.get(cache.getDepartment()));
		cache.dcrs = (IDCRS) registry.lookup(cache.getDepartment());*/
